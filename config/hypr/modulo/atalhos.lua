...
hl.bind(mainMod .. " + V", hl.dsp.window.float({ action = "toggle" })) --Alterna o modo "flutuante" da janela
hl.bind(mainMod .. " + space", hl.dsp.exec_cmd(menu))

--Screenshot: região
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd("hyprshot -m region"))
...
-- ncador de apps 
--hl.bind(mainMod .. " + space", hl.dsp.exec_cmd("cliphist list | rofi -dmenu | cliphist decode | wl-copy"))
